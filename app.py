...
vectordbFAQ_BGC = Chroma(persist_directory="C:/Users/PriKumar/AIML/IBM POC/storage/rc_docs", embedding_function=embeddings)
# chain = ConversationalRetrievalChain.from_llm(llm=llm, retriever=vectordbFAQ_BGC.as_retriever())
chain = RetrievalQA.from_chain_type(llm=llm, chain_type="map_reduce", retriever=vectordbFAQ_BGC.as_retriever())
